...
NET_FILE = PROJECT_ROOT / "new_network.net.xml"
ROUTE_FILE = PROJECT_ROOT / "new_golden_routes.rou.xml" 
STATS_FILE = STATS_DIR / "report_baseline.txt"
...
if not ROUTE_FILE.exists():
    sys.exit("Не знайдено golden_routes.rou.xml")
...
print("Стандартний світлофор (Baseline)")
...
report_content = f"""
=========================================
ЗВІТ: СТАНДАРТНИЙ СВІТЛОФОР (Baseline)
=========================================
