...
def test_model():
    print("Запуск тестування моделі Custom DQN (Реальний трафік)")
    
    current_dir = Path(__file__).parent
    model_path = current_dir.parent / "stats" / "custom_dqn_model.pth"
    report_path = current_dir / "stats" / "report_real_custom_dqn.txt"
    ...
    report_content = f"""
=========================================
ЗВІТ: ВЛАСНА НЕЙРОМЕРЕЖА (Custom DQN) НА РЕАЛЬНОМУ ТРАФІКУ
=========================================
