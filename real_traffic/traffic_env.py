...
class SumoTrafficEnv(gym.Env):
    def __init__(self, gui=False):
        ...
        self.proj_root = Path(r"C:\Users\GAMEMAX\Desktop\univer\Traffic_AI")
        self.net_file = self.proj_root / "maps" / "network.net.xml"
        self.route_file = self.proj_root / "real_traffic" / "real_routes.rou.xml"
    ...
    def reset(self, seed=None, options=None):
        ...
        if self.tls_id is None:
            ...
            obs_size = len(self.incoming_lanes) + 2 + 1
