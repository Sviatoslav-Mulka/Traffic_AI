...
def main():
    print("Запуск тестування PPO (Реальний трафік)")
    
    env = SumoTrafficEnv(gui=True)
    
    current_dir = Path(__file__).parent
    model_path = current_dir.parent / "stats" / "ppo_traffic_model"
    ...
    report = f"""
=========================================
ЗВІТ: ПРОФЕСІЙНИЙ ШІ (PPO) НА РЕАЛЬНОМУ ТРАФІКУ
=========================================
...
"""
    ...
    stats_dir = current_dir / "stats"
    report_path = stats_dir / "report_real_ppo.txt"
